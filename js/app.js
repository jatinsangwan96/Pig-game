...
var scores, roundScore, activerPlayer, gamePlaying;

init();

// For Clicking the ROLL DICE Button
...
document.querySelector('.btn-hold').addEventListener('click', function() {
    ...
    if (gamePlaying) {
        ...
        // UNDEFINED, NULL, "" or 0 are COERCED to False
...
// For Clicking the New Game Button
